...
class MoviesListViewModel(private val interactor: MoviesListInteractor) : ViewModel() {
    ...
    val currentFindName: LiveData<String> get() = mutableCurrentFindName
    val currentMovePosition: LiveData<Int> get() = mutableCurrentMovePosition
    ...
    fun updateLoadMovies() {
        if (mutableUpdateMoviesList.value != true) {
